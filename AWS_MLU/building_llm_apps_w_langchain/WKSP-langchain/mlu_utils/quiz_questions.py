...
lab1_question1 = Quiz(
    question={
        "question": "Which AWS product provides a serverless solution for building GenAI applications using foundational models?",
        "options": [
            "DeepRacer",
            "GroundTruth",
            "S3",
...
lab2_question1 = Quiz(
    question={
        ...
        "options": [
            ...
            "ConversationalSummaryBufferMemory",
            "None of the above",
        ],
        "correctIndex": 2,
    }
...
lab2_question2 = Quiz(
    question={
        "question": "How does the RouterChain decide the destination chain?",
        "options": [
            "Random selection of destination chain",
            "Cosine similarity to search and select the destination chain",
            "The LLM reasons and selects the destination chain based on the prompt and the description of each chain",
            "The user needs to select the right destination chain each time",
        ],
        "correctIndex": 2,
    }
)
